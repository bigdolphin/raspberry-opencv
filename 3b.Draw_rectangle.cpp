...
int main()
{
        ...
        //Ve hinh chu nhat/vuong
        rectangle( image,                           //ten ma tran
                   Point(image.cols/8,image.cols/2),//Goc tren - ben trai
                   Point(image.cols/4,image.cols/4),//Goc duoi - ben phai
                   Scalar( 0, 255, 255 ),           //Mau sac
